(function ($) {
    ...
    $(document).ready(function () {
        ...
        var devdate = new Date('2010/12/25 00:00:00');
        var birthdate = new Date('1995/10/23 01:45:00');
        var now = new Date();
        var age = Math.floor((now - birthdate) / (1000 * 60 * 60 * 24 * 365.25));
        var devsince = Math.floor((now - devdate) / (1000 * 60 * 60 * 24 * 365.25));
        
        $('[data-age]').text(age);
        $('[data-dev-since]').text(devsince);
